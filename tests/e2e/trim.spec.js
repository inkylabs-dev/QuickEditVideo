...
test.describe('Trim page', () => {
  ...
  test('should trim video with start and end time and download file', async ({ page }) => {
    await page.goto('/trim');
  ...
  test('should trim video with timeline drag handles and download file', async ({ page }) => {
    await page.goto('/trim');
    ...
    // Set specific trim points using number inputs (simulating timeline drag)
    const startTimeInput = page.locator('input[type="number"]').first();
    await startTimeInput.fill('0.5');
    
    const endTimeInput = page.locator('input[type="number"]').last();
    await endTimeInput.fill('2.5');
  ...
  test('should trim video with precise timing and download file', async ({ page }) => {
    await page.goto('/trim');
    ...
    // Set precise timing (frame-perfect precision)
    const startTimeInput = page.locator('input[type="number"]').first();
    await startTimeInput.fill('0.25');
    
    const endTimeInput = page.locator('input[type="number"]').last();
    await endTimeInput.fill('1.75');
